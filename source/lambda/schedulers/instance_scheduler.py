...
class InstanceScheduler:
    ...
    def _process_account(self, account):
        ...
        for region in self._regions:
            ...
            for instance in self._scheduled_instances_in_region(account, region):
                ...
                if hasattr(instance, 'service_stop'):
                    if instance.service_stop and instance.is_running:
                ...
                print(instance_schedule.stop_new_instances)
                print(instance_schedule.name)
                print(instance_schedule.enforced)
    ...
    def _scheduled_services_in_region(self, account, region):
